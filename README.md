...
### Source
Reported Hate Crime data from 1991 to 2022, sourced from FBI public data sets (1), alongside data on periods of social unrest in the United States during the same timeframe, primarily gathered from Wikipedia (2).
...
## References
- (1) [FBI Hate Crime Data Set](https://cde.ucr.cjis.gov/LATEST/webapp/#/pages/downloads#datasets)
- (2) [Wikiepedia Social Unrest Data Source](https://en.wikipedia.org/wiki/List_of_incidents_of_civil_unrest_in_the_United_States#1990%E2%80%931999)
